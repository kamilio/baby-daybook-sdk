...
export const paths = {
  ...
  baby: (babyUid: string) => `babyData/babyUid_${babyUid}`,
  babyCollection: (babyUid: string, collection: BabyCollectionName) => `babyData/babyUid_${babyUid}/${collection}`,
  babyAcceptedInvites: (babyUid: string) => `babyData/babyUid_${babyUid}/acceptedInvites`,
  babyPendingInvites: (babyUid: string) => `babyData/babyUid_${babyUid}/pendingInvites`,
  ...
  fileMetadata: (babyUid: string, category: AttachmentCategory) => `babyData/babyUid_${babyUid}/${category}Files`,
} as const;
